...
//     	   	this.getWindow().setBackgroundDrawable(bg_drawable);      	   	
     	   	//bt_drawable = res.getDrawable(R.drawable.frame_button_background_red);
        }
 

        
        
        inStream = this.getClass().getClassLoader().getResourceAsStream("getnews.xml");
        try  
	      { 
		...
		one.setOnClickListener(new OnClickListener() {					
			public void onClick(View v) {
                ...
                setTitle("新闻公告").  
                setItems(arraygg,new DialogInterface.OnClickListener() {//Items to choose  
                    @Override  
                    public void onClick(DialogInterface dialog, int which) {  
                        Toast.makeText(Menu.this, arraygg[which], Toast.LENGTH_LONG).show(); 
                        if(which==1)
                        {
                        	 flag = 12;
                             ts.setText("单位公告");
                ...
                setNegativeButton("取消选择", new DialogInterface.OnClickListener() {//cancel  
		...
		three.setOnClickListener(new OnClickListener() {				
			public void onClick(View v) {
				...
				new AlertDialog.Builder(Menu.this).  
                setTitle("内部邮件").  
                setItems(arrayem,new DialogInterface.OnClickListener() {//Items to choose  
                    @Override  
                    public void onClick(DialogInterface dialog, int which) {  
                        Toast.makeText(Menu.this, arrayem[which], Toast.LENGTH_LONG).show(); 
                        if(which==1)
                        {
                        	 flag = 22;
                             ts.setText("收件箱");
...
//        rw.setOnClickListener(drw);                
	...
	public void showView(int flag) {
		...
		case 21:	
			...
			bodyView.addView(getLocalActivityManager().startActivity("three", intent21).getDecorView());
			ts.setText("发邮件")	;		
			one.setBackgroundResource(R.drawable.frame_button_nopressbg);
			two.setBackgroundResource(R.drawable.frame_button_nopressbg);
		...
		case 22:	
			...
			bodyView.addView(getLocalActivityManager().startActivity("three", intent22).getDecorView());
			ts.setText("收件箱");		
			one.setBackgroundResource(R.drawable.frame_button_nopressbg);
			two.setBackgroundResource(R.drawable.frame_button_nopressbg);
			three.setBackgroundDrawable(bt_drawable);
		...
		case 3:		
			...
			bodyView.addView(getLocalActivityManager().startActivity("four", intent2).getDecorView());
			ts.setText("我的会签");
			one.setBackgroundResource(R.drawable.frame_button_nopressbg);
			two.setBackgroundResource(R.drawable.frame_button_nopressbg);
			three.setBackgroundResource(R.drawable.frame_button_nopressbg);
		...
		case 4:
			...
			bodyView.addView(getLocalActivityManager().startActivity("five", intent3).getDecorView());
			ts.setText("设置");
			one.setBackgroundResource(R.drawable.frame_button_nopressbg);
			two.setBackgroundResource(R.drawable.frame_button_nopressbg);
			three.setBackgroundResource(R.drawable.frame_button_nopressbg);
...
//			// TODO 自动生成的方法存根
//			
//			InputStream inStream = this.getClass().getClassLoader().getResourceAsStream("getnews.xml");
//	        try  
//            { 
